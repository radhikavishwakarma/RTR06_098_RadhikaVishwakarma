...
int main(void)
{
    ...
    printf("iArray[5] (6th Eements) = %d \n",iArray[5]);
    printf("iArray[6] (7th Elements) = %d \n",iArray[6]);
    ...
    printf("Number of Elements In 'int' Array 'iArray[]'  = %d Elements ",iArray_num_elements);
    ...
    printf("fArray[9] (10 Element) = %f \n",fArray[9]);

    float_size = sizeof(float);
    fArray_size = sizeof(fArray);
    fArray_num_elements =fArray_size /float_size;
    printf("Size OF Data type 'float' Array 'fArray[]' = %d Elements\n",float_size);
    printf("Number OF Elements In 'float' Array 'fArray[]' = %d Elements",fArray_num_elements);
    printf("Size pf Array 'fArray[]' (%d Elements * %d Bytes) = %d Bytes\n",fArray_num_elements,float_size,fArray_size);
    ...
    printf("cArray[9] (10 the Element) = %c\n",cArray[9]);
