...
int main(void)
{
    ...
    printf("Size of Three Dimensional (3D) Integre Array IS = %d\n\n",iArray_size);
    ...
    printf("Depeth In Three Dimensional (3D) Intger Array Is = %d\n\n",iArray_depth);
    ...
    printf("\n\n");
    printf("Elements In Therger 3D Array :\n\n");
