...
int main(void)
{
    ...
    printf("Size of Three Dimensioanl (3D) Intger Array IS = %d\n\n",iArray_size);
  
    iArray_width = iArray_size / sizeof(iArray[0]);
    printf("Number of Rows(Width) In Three Dimesiona (3D) Intger Array Is - %d\n\n",iArray_width);
    ...
    printf("Depth In Three Dimensional (3D) Intger array IUs = %d\n\n",iArray_depth);
