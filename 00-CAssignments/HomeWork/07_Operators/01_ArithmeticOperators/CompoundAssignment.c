...
int main(void)
{
    ...
    x = a;
    a -= b; // a = a - b
    printf("Subraction Of A = %d And B = %d Gives %d.\n", x, b, a);
    ...
    //Value Of 'a' Altered In The Above Expression Is Used Here...
    //Since, 'a' Will Be Assigned The Value Of (a / b) At The Expression (a /= b), We Must Save The Orginal Value Of 'a' To Another Variable (x)
    x = a;
    a /= b; // a = a / b
