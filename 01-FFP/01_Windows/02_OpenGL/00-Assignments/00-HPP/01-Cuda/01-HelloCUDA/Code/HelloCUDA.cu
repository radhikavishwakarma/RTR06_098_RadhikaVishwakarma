...
int main(void)
{
    ...
    {
        printf("Device Memory alloction is failed for deviceInput1 array.\n");
        cleanup();
        exit(EXIT_FAILURE);
    }
    ...
    if (result != cudaSuccess)
    {
        printf("Device Memory alloction is failed for deviceInput2 array.\n");
        cleanup();
        exit(EXIT_FAILURE);
    }
    ...
    if (result != cudaSuccess)
    {
        printf("Device Memory alloction is failed for deviceOutput array.\n");
        cleanup();
        exit(EXIT_FAILURE);
    }
