...
void display(void)
{
    ...
    drawCircle(255, 0, 0); // Called function
    glPopMatrix();

	glPushMatrix();
    glTranslated(0.0, 0.0, 0.0);
    glScaled(1.5, 1.5, 0.0);
    drawCircle(0, 255, 0); // Called function
    glPopMatrix();

	glPushMatrix();
    glTranslated(0.0, 0.0, 0.0);
    glScaled(2.5, 2.5, 0.0);
    drawCircle(0, 0, 255); // Called function
    glPopMatrix();

	glPushMatrix();
    glTranslated(0.0, 0.0, 0.0);
    glScaled(3.5, 3.5, 0.0);
    drawCircle(0, 255, 255); // Called function
    glPopMatrix();

	glPushMatrix();
    glTranslated(0.0, 0.0, 0.0);
    glScaled(4.5, 4.5, 0.0);
    drawCircle(255, 0, 255); // Called function
    glPopMatrix();

	glPushMatrix();
    glTranslated(0.0, 0.0, 0.0);
    glScaled(5.5, 5.5, 0.0);
    drawCircle(255, 255, 0); // Called function
    glPopMatrix();

	glPushMatrix();
    glTranslated(0.0, 0.0, 0.0);
    glScaled(6.5, 6.5, 0.0);
    drawCircle(255, 255, 255); // Called function
    glPopMatrix();

	glPushMatrix();
    glTranslated(0.0, 0.0, 0.0);
    glScaled(7.5, 7.5, 0.0);
    drawCircle(163, 38, 240); // Called function
    glPopMatrix();

	glPushMatrix();
    glTranslated(0.0, 0.0, 0.0);
    glScaled(8.5, 8.5, 0.0);
    drawCircle(138, 138, 138); // Called function
    glPopMatrix();

	glPushMatrix();
    glTranslated(0.0, 0.0, 0.0);
    glScaled(9.5, 9.5, 0.0);
    drawCircle(255, 119, 8); // Called function
    glPopMatrix();
