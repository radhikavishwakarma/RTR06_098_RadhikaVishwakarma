...
void display(void)
{
    ...
    drawTriangle(angleTriangle, translateTriangleX, translateTriangleY); // Called function
...
void drawTriangle(float angleTriangle, float translateTriangleX, float translateTriangleY)
{
	// Draw Line here
	...
	glTranslatef(translateTriangleX, translateTriangleY, 0.0f);
...
void drawCircle(float angleCircle, float translateCircleX, float translateCircleY)
{
	glColor3f(1.0f, 1.0f, 0.0f);
	glLineWidth(4.0f);
	glLoadIdentity();

	glTranslatef(translateCircleX, translateCircleY, 0.0f);
	...
	for (double angle = 0; angle <= 360; angle += 0.01f)
	{
		...
		y = (radius * sin(radian_angle)) - 0.19f;
		glVertex2d(x, y);
	}
	glEnd();
}

void drawLine(float translateLineY)
{
	glColor3f(1.0f, 1.0f, 0.0f);
	glLineWidth(4.0f);
	glLoadIdentity();
	glTranslatef(0.0f, translateLineY, 0.0f);
	// Draw Line here
	glBegin(GL_LINES);
	glVertex3f(0.0f, 0.5f, 0.0f);
	glVertex3f(0.0f, -0.5f, 0.0f);
