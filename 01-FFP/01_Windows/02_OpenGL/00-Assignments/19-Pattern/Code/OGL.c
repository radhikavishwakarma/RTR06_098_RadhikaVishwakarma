...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	void drawFilledSquare(int x, int y, float r, float g, float b);
...
{
	// function declaration
	void drawPattern1(void);
	void drawPattern2(void);
	void drawPattern3(void);
	void drawPattern4(void);
	void drawPattern5(void);
	void drawPattern6(void);
    // code
...
void drawPattern1(void)
{
	...
	for (int x = 0; x < 4; x++)
	{
		for (int y = 0; y < 4; y++)
		{
			glVertex3f((float)x * 0.1f, (float)y * 0.1f, 0.0f);
		}
	}
    glEnd();
}
...
void drawPattern6(void)
{
	for (int x = 0; x < 3; x++)
	{
		for (int y = 0; y < 3; y++)
		{
			if(x == 0) // for red
			{
				drawFilledSquare(x, y, 1.0f, 0.0f, 0.0f);
				drawSquare(x, y);
			}
			else if(x == 1) // for green
			{
				drawFilledSquare(x, y, 0.0f, 1.0f, 0.0f);
				drawSquare(x, y);
			}
			else if(x == 2) // for blue
			{
				drawFilledSquare(x, y, 0.0f, 0.0f, 1.0f);
				drawSquare(x, y);
			}
		}	
	}
...
void drawTriangle(int x, int y)
{
	...
	glVertex3f(0.0f + (float)x * 0.1f, 0.0f + (float)y * 0.1f, 0.0f);
    glVertex3f(0.1f + (float)x * 0.1f, 0.1f + (float)y * 0.1f, 0.0f);
    glVertex3f(0.0f + (float)x * 0.1f, 0.1f + (float)y * 0.1f, 0.0f);
...
void drawSquare(int x, int y)
{
	...
	glVertex3f(0.0f + (float)x * 0.1f, 0.0f + (float)y * 0.1f, 0.0f);
	glVertex3f(0.1f + (float)x * 0.1f, 0.0f + (float)y * 0.1f, 0.0f);
    glVertex3f(0.1f + (float)x * 0.1f, 0.1f + (float)y * 0.1f, 0.0f);
    glVertex3f(0.0f + (float)x * 0.1f, 0.1f + (float)y * 0.1f, 0.0f);
