...
void display(void)
{
	...
	rotationMatrixX[5] = cos(lightAngle0);
	rotationMatrixX[6] = sin(lightAngle0);
	rotationMatrixX[7] = 0.0f;
	rotationMatrixX[8] = 0.0f;
	rotationMatrixX[9] = -sin(lightAngle0);
	rotationMatrixX[10] = cos(lightAngle0);
	...
	// RotationMatrixZ
	rotationMatrixZ[0] = cos(lightAngle2);
	rotationMatrixZ[1] = sin(lightAngle2);
	rotationMatrixZ[2] = 0.0f;
	rotationMatrixZ[3] = 0.0f;
	rotationMatrixZ[4] = -sin(lightAngle2);
	rotationMatrixZ[5] = cos(lightAngle2);
