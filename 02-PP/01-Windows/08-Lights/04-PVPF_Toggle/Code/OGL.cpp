...
GLuint laUniform_pv = 0;
GLuint ldUniform_pv = 0;
GLuint lsUniform_pv = 0;
...
GLuint laUniform_pf = 0;
GLuint ldUniform_pf = 0;
GLuint lsUniform_pf = 0;
...
void display(void)
{
	...
	translationMatrix = vmath::translate(0.0f, 0.0f, -2.0f); // translate backwards
	mat4 scaleMatrix = mat4::identity();
	scaleMatrix = vmath::scale(0.75f, 0.75f, 0.75f);
	mat4 rotationMatrixY = mat4::identity();
	rotationMatrixY = vmath::rotate(angleSphere, 0.0f, 1.0f, 0.0f);
