...
void display(void)
{
	...
	translationMatrix = vmath::translate(0.0f, 0.0f, -6.0f); //translate pyramid backwards
	mat4 rotationMatrix = mat4::identity();
	rotationMatrix = vmath::rotate(angledPyramid, 0.0f, 1.0f, 0.0f);
...
{
	// code
	angledPyramid = angledPyramid + 0.1f;
	if(angledPyramid >= 360.0f)
	{
		angledPyramid = angledPyramid - 360.0f;
	}
}
