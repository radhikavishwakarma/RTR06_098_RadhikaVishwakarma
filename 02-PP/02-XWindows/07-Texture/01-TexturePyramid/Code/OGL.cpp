...
int initialize(void)
{
	...
	// Load Textures
	if(loadGLTexture(&texture_stone, "stone.bmp") == False) // To have this function execute sucessfully file should be present in the folder
	{
		fprintf(gpFile, "Loading stone texture failed!\n");
		return(-6);
	}
