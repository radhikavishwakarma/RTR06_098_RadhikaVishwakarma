...
function main()
{
    ...
    function keyDown(event)
    {
        ...
        switch(event.keyCode)
        {
            case 49: // for '1' key
                ...
                console.log("Key pressed is 1");
                break;
            case 50: // for '2' key
                keyPressed = 2;
                gl.enable(gl.TEXTURE_2D);
                console.log("Key pressed is 2");
                break;
            case 51: // for '3' key
                keyPressed = 3;
                gl.enable(gl.TEXTURE_2D);
                console.log("Key pressed is 3");
                break;
            case 52: // for '4' key
                keyPressed = 4;
                gl.enable(gl.TEXTURE_2D);
                console.log("Key pressed is 4");
                break;
            case 70:
            case 102:
    ...
    function initialize()
    {
        ...
        gl.bufferData(gl.ARRAY_BUFFER, rectangle_texcoord, gl.DYNAMIC_DRAW);
    ...
    function display()
    {
        ...
        if(keyPressed == 1)
        {
            ...
            rectangle_texcoord = new Float32Array([
                0.5, 0.5, // Top Right
                0.0, 0.5, // Top Left
                0.0, 0.0, // Bottom Left
        ...
        {
            gl.uniform1i(keyPressUniform, 2);
            rectangle_texcoord = new Float32Array([
                1.0, 1.0, // Top Right
                0.0, 1.0, // Top Left
                0.0, 0.0, // Bottom Left
        ...
        {
            gl.uniform1i(keyPressUniform, 3);
            rectangle_texcoord = new Float32Array([
                2.0, 2.0, // Top Right
                0.0, 2.0, // Top Left
                0.0, 0.0, // Bottom Left
        ...
        {
            gl.uniform1i(keyPressUniform, 4);
            rectangle_texcoord = new Float32Array([
                0.2, 0.2, // Top Right
                0.2, 0.2, // Top Left
                0.2, 0.2, // Bottom Left
