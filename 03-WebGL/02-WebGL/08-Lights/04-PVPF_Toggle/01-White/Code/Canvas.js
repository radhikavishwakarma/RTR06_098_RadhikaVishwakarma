...
function main()
{
    ...
    function keyDown(event)
    {
        ...
        switch(event.keyCode)
        {
            ...
            case 102:
                ...
                bPerFragment = true;
                bPerVertex = false;
                console.log("Per Fragment Lighting");
                break;
            case 86:
            case 118:
                // V or v key
                bPerFragment = false;
                bPerVertex = true;
                console.log("Per Vertex Lighting");
                break; 
            case 69:
                uninitialize();
                window.close();
    ...
    function display()
    {
	    ...
	    if ((bPerVertex == true) && (bPerFragment == false))
        {
            ...
            gl.uniformMatrix4fv(modelMatrixUniform_pv, gl.FALSE, modelMatrix);
            gl.uniformMatrix4fv(viewMatrixUniform_pv, gl.FALSE, viewMatrix);
            gl.uniformMatrix4fv(projectionMatrixUniform_pv, gl.FALSE, perspectiveProjectionMatrix);
	    ...
	    else if ((bPerVertex == false) && (bPerFragment == true))
        {
            ...
            // send above matrix to the shader in "uniform"
            gl.uniformMatrix4fv(modelMatrixUniform_pf, gl.FALSE, modelMatrix);
            gl.uniformMatrix4fv(viewMatrixUniform_pf, gl.FALSE, viewMatrix);
            gl.uniformMatrix4fv(projectionMatrixUniform_pf, gl.FALSE, perspectiveProjectionMatrix);
