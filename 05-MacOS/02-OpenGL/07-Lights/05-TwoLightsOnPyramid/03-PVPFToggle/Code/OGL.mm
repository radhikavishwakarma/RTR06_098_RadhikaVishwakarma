...
@implementation GLView
{
	...
	GLuint laUniform_perVertex[2];
	GLuint ldUniform_perVertex[2];
	GLuint lsUniform_perVertex[2];
	GLuint lightPositionUniform_perVertex[2];
	...
	// Uniform related to lights
	GLuint laUniform_perFragment[2];
	GLuint ldUniform_perFragment[2];
	GLuint lsUniform_perFragment[2];
	GLuint lightPositionUniform_perFragment[2];
...
-(void)display
{
	...
	if (bLight == TRUE)
	{
		if (bPerVertexLight == TRUE)
		{
			...
			glUniform4fv(lightPositionUniform_perVertex[0], 1, light[0].position);
			...
			glUniform4fv(lightPositionUniform_perVertex[1], 1, light[1].position);
		...
		else if (bPerFragmentLight == TRUE)
		{
			...
			glUniform4fv(lightPositionUniform_perFragment[0], 1, light[0].position);
			...
			glUniform4fv(lightPositionUniform_perFragment[1], 1, light[1].position);
