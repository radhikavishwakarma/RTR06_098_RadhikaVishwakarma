...
-(int)initialize
{
    ...
    singleTapUniform = glGetUniformLocation(shaderProgramObject, "uSingleTap");
    ...
    if (texture_Smiley == 0)
    {
        printf("loadGLTexture() for Smiley failed!\n");
...
-(void)display
{
    ...
    modelViewMatrix = translationMatrix;    // Order is important (Matrix multiplication is non-commutative)
    ...
    case 2:
        ...
        smiley_TexCoord[7] = 0.0f;
        glUniform1i(singleTapUniform, 2);
        break;
    ...
    case 3:
        ...
        smiley_TexCoord[7] = 0.0f;
        glUniform1i(singleTapUniform, 3);
        break;

    case 4:
        smiley_TexCoord[0] = 0.5f;
        smiley_TexCoord[1] = 0.5f;
        smiley_TexCoord[2] = 0.5f;
        smiley_TexCoord[3] = 0.5f;
        smiley_TexCoord[4] = 0.5f;
        smiley_TexCoord[5] = 0.5f;
        smiley_TexCoord[6] = 0.5f;
        smiley_TexCoord[7] = 0.5f;
        glUniform1i(singleTapUniform, 4);
        break;
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(smiley_TexCoord), smiley_TexCoord, GL_DYNAMIC_DRAW);
