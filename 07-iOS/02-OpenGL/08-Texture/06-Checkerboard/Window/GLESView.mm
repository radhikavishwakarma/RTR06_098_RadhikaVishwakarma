...
-(void)loadGLTexture
{
    ...
    // Step 1: Generate OpenGL texture object
    glGenTextures(1, &texture_Checkerboard);

    // Step 2: Bind to the newly created empty structure object
    glBindTexture(GL_TEXTURE_2D, texture_Checkerboard);

    // Step 3: Unpack the image into memory for faster loading
