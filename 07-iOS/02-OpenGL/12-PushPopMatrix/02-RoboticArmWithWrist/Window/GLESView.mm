...
-(void)display
{
    ...
    modelViewMatrix *= vmath::rotate((GLfloat)shoulder, 0.0f, 0.0f, 1.0f);
    modelViewMatrix *= vmath::translate(1.0f, 0.0f, 0.0f);
    modelMatrix = modelViewMatrix;      // To save Old matrix
    modelViewMatrix *= vmath::scale(2.1f, 0.6f, 1.0f);
    ...
    glUniform4fv(sphereColorUniform, 1, vmath::vec4(0.5f, 0.35f, 0.05f, 1.0f));
    ...
    modelViewMatrix *= vmath::translate(1.0f, 0.0f, 0.0f);
    modelViewMatrix *= vmath::rotate((GLfloat)elbow, 0.0f, 0.0f, 1.0f);
    modelViewMatrix *= vmath::translate(1.0f, 0.0f, 0.0f);
    ...
    modelViewMatrix = modelMatrix;
    modelViewMatrix *= vmath::translate(1.0f, 0.0f, 0.0f);
    modelViewMatrix *= vmath::rotate((GLfloat)wrist, 0.0f, 0.0f, 1.0f);
    modelViewMatrix *= vmath::translate(0.4f, 0.0f, 0.0f);
    modelViewMatrix *= vmath::scale(0.8f, 0.3f, 1.0f);
...
-(void)myUpdate
{
    ...
    else if(iSingleTap == 5)
    {
        wrist = (wrist - 3) % 360;
    }
    else if(iSingleTap == 8)
    {
        wrist = (wrist + 3) % 360;
    }
