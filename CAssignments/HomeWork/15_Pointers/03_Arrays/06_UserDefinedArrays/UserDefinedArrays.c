...
int main(void)
{
    ...
    {
        printf("\n\n");
        printf("Memory allocation For floating-pointer Array failed !!! Existing now...\n\n");
        exit(0);
    }
    else
    {
        printf("\n\n");
        printf("Memory Allocation for floating-point array Succeeded !!!|n\n");
    }
    ...
    // ***Double **
    printf("\n\n");
    printf("The Double Array Entered By Your and Consisting of %d Elements is As follows : \n\n", doubleArratLenght);
    for (i = 0; i < doubleArratLenght; i++)
